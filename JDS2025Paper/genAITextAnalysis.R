...
# Put data files in a subdirectory called "Data". 

### Reading level analysis. Reading levels are in a separate excel file
...
# Read in 3 files: GPT35Answers.docx, GPT4Answers.docx, GPT4oMiniAnswers.docx
...
# library(wordcloud) - no longer needed
